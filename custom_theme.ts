...
export const customTheme: CustomThemeConfig = {
	...
	properties: {
		...
		'--color-secondary-100': '253 253 248', // #fdfdf8
		'--color-secondary-200': '253 253 246', // #fdfdf6
		'--color-secondary-300': '251 251 241', // #fbfbf1
		'--color-secondary-400': '248 248 231', // #f8f8e7
		'--color-secondary-500': '245 245 220', // #F5F5DC
		'--color-secondary-600': '221 221 198', // #ddddc6
		'--color-secondary-700': '184 184 165', // #b8b8a5
		'--color-secondary-800': '147 147 132', // #939384
		'--color-secondary-900': '120 120 108', // #78786c
		// tertiary | #0EA5E9
